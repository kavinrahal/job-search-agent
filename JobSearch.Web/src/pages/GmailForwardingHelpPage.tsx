...
const STEPS: StepDef[] = [
  ...
  },
  {
    ...
    description:
      // Gmail's own confirmation email for this address goes to WorkSanta's inbox, not the
      // user's — there's genuinely nothing for them to open or click, so this folds straight
    ...
    <div className="max-w-[720px] space-y-6">
      {!hideHeader && (
        <PageHeader
          ...
          tagline="Five steps in Gmail's own settings. WorkSanta takes over automatically once the address is confirmed."
        />
      )}
