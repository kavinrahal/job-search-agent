...
// LandingPage.tsx) the same way the hero sits under the ember one at the top. The mesh + single
// glow pulse below are this section's own, additional ambient treatment on top of that page-level
// glow — layered, not a replacement for it.
    ...
    >
      <Reveal className="relative">
        ...
        <div className="flex flex-col items-center justify-center gap-2.5 sm:flex-row">
          <Button href="/register" cap className="will-change-transform" {...magneticHoverProps()}>
            Create account
          </Button>
          <Button href={loginUrl} variant="ghost" className="will-change-transform" {...magneticHoverProps()}>
            Sign in with Google
          </Button>
        </div>
      </Reveal>
